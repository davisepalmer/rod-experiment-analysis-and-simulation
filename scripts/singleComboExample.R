# Plots one water-added/shape combination and overlays its fitted regression curve.
...
plot_output_file = file.path(plot_output_dir, paste0(combo_prefix, "_single_combo_plot.png"))
...
lines(displacement_grid, regression_curve, lwd = 3)
